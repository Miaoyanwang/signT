...
save(error,error_con,file=paste("Figure4-dimension",d,".RData",sep=""))
...
save(error,error_con,file="Model4.RData")
#######################
...
pdf("Model4.pdf",width=4,height=3)
...
source("../signT.R")
signal=graphon_to_tensor(a,a,a,type=9)
pdf("cdf_model4.pdf",height=5,width=10)
...
#source("../signT.R")
#truer=2
#error_con=error=matrix(0,nrow=10,ncol=3)
#for(BATCH in 1:5){
#d=d_list[2*BATCH]
#### simulate graphon models
#a=seq(from=0,to=1,length=d)
