...
\section{Conclusion}
We have develop a new framework for high-rank tensor estimation based on sign tensor representation. The new method improves the predictive power and enhances interpretability by nonparametric estimation of signal tensors. The application to brain connection dataset and author-topic mining shows the practical utility of the proposed method.
