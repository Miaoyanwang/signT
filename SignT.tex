...
%\begin{table}
%\begin{tabular}{ccccc}
%ID &signal tensor $\Theta$ & $\rank(\Theta)$ &  $\srank(\Theta)$ \\
%\hline
%1& $\ma^{\otimes 3}+\mb^{\otimes 3}$ &2&  Bernoulli\\
%1(done)& $\tC\times\mM_1\times\mM_2\times\mM_3$ &$3^3$&2\\
%2 & $|\ma\otimes \mathbf{1}\otimes\mathbf{1}-\mathbf{1}\otimes\mb\otimes \mathbf{1}|$& $\geq d$&unknown\\
%3 (done)& $\log(0.5+\tZ^2_{\max})$&$\geq d$& 2\\
%4 (done)& $1-\exp(-0.5\tZ_{\min})$& $\geq d$ & 2 \\
