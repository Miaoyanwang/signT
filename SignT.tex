...
By definition, the sign-rank is upper bounded by the tensor rank, and it enjoys invariance under every monotonic transformation. 
...
%In particular, the family $\caliP(r+1)$ enjoys invariance under every monotonic transformation. 
\end{example}
