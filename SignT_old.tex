...
By definition, the sign-rank is upper bounded by the tensor rank. More generally, 
...
\]
\end{prop}
Conversely, the sign-rank can be dramatically smaller than the usual rank, as we have shown in the examples of Section~\ref{sec:intro}.
