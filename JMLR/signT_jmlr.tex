...
\jmlrheading{1}{2021}{1-48}{4/00}{10/00}{Chanwoo Lee and Miaoyan Wang}

% Short headings should be running head and authors last names

\ShortHeadings{Tensor Completion via Sign Series}{Lee  and Wang}
\firstpageno{1}
...
In this paper, we present sign-representable tensor model with a new notion of sign-rank that can successfully handle high rank tensors with low complexity.
...
%Our approach is built on the sign series representation of the signal tensor, and we propose to estimate the sign tensors through a series of weighted classifications. In contrast to existing methods, our method is guaranteed to recover a wide range of low- and high-rank signals.  
...
\multirow{2}{*}{Generalized linear model }                &\multirow{2}{*}{1}        &\multirow{2}{*}{0}  &       \multirow{2}{*}{$-(K-1)/3$}  & {Close to minimax rate }   \\
&&&& \citep{wang2018learning,hu2021generalized}.\\
...
Theoretical results in Section~\ref{sec:error}  are based on bounded observation $\|\tY\|_\infty\leq 1$. In this section, we extend the results to unbounded observation and present the estimation errors for various type of noise.
