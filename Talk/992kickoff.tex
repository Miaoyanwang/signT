...
\\[.2cm] \onslide<2->{{\color{red}Applying matrix methods  to higher-order tensor destroys structural information.}}

	\onslide<3->{\item Low rank tensor model~\citep{jain2014provable,montanari2018spectral,cai2019nonconvex}}
	\\[.2cm] \onslide<4->{{\color{red} Low rank models are inadequate in many cases.}}
	\end{itemize}
